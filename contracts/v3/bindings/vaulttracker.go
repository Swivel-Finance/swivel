...
//
// Solidity: function vaults(address ) view returns(uint256 notional, uint256 redeemable, uint256 exchangeRate, uint256 accrualBlock)
func (_VaultTracker *VaultTrackerCaller) Vaults(opts *bind.CallOpts, arg0 common.Address) (struct {
	Notional     *big.Int
	Redeemable   *big.Int
	ExchangeRate *big.Int
	AccrualBlock *big.Int
}, error) {
	var out []interface{}
	...
	outstruct.AccrualBlock = *abi.ConvertType(out[3], new(*big.Int)).(**big.Int)
...
// Rates is a paid mutator transaction binding the contract method 0x43f48fbd.
//
// Solidity: function rates() returns(uint256, uint256)
func (_VaultTracker *VaultTrackerTransactor) Rates(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _VaultTracker.contract.Transact(opts, "rates")
}

// Rates is a paid mutator transaction binding the contract method 0x43f48fbd.
//
// Solidity: function rates() returns(uint256, uint256)
func (_VaultTracker *VaultTrackerSession) Rates() (*types.Transaction, error) {
	return _VaultTracker.Contract.Rates(&_VaultTracker.TransactOpts)
}

// Rates is a paid mutator transaction binding the contract method 0x43f48fbd.
//
// Solidity: function rates() returns(uint256, uint256)
func (_VaultTracker *VaultTrackerTransactorSession) Rates() (*types.Transaction, error) {
	return _VaultTracker.Contract.Rates(&_VaultTracker.TransactOpts)
}
